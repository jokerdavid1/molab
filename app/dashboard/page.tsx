          ...
          <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="rounded-[24px] border border-white/10 bg-black/20 p-8">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <Link
                  href="/upload"
                  className="rounded-xl border border-cyan-300/30 bg-cyan-400/20 px-6 py-3 text-sm font-medium text-cyan-200 shadow-[0_0_20px_rgba(34,211,238,0.18)] transition hover:scale-[1.02] hover:bg-cyan-400/30"
                >
                  Go to Upload Page
                </Link>
